...
var Deck = (function () {
  ...
  function _card(i) {
    ...
    self.setRankSuit = function (rank, suit) {
      ...
      $el.setAttribute('class', 'bj_card ' + suitName + ' rank' + rank);
    };
  ...
  function Deck(jokers,no) {
    // init cards array
    var deck_multiplier=no?no:1;

    var cards = new Array(jokers ? 55*deck_multiplier : 52*deck_multiplier);
